...
@section('titre', 'Modifier une réparation')

@section('contenu')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Modifier la réparation n°{{ $reparation->id }}</h1>
    <a href="{{ route('reparations.show', $reparation) }}" class="btn btn-outline-secondary btn-sm">&larr; Retour</a>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('reparations.update', $reparation) }}">
            @csrf
            @method('PUT')
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="date" id="date" class="form-control"
                           value="{{ old('date', $reparation->date) }}" required>
                </div>
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.5" min="0" name="duree_main_oeuvre" id="duree_main_oeuvre"
                           class="form-control" value="{{ old('duree_main_oeuvre', $reparation->duree_main_oeuvre) }}" required>
                </div>
            </div>
            ...
            <div class="mt-3">
                ...
                <input type="text" name="objet_reparation" id="objet_reparation" class="form-control"
                       value="{{ old('objet_reparation', $reparation->objet_reparation) }}" required>
            </div>
            ...
            <div class="mt-3">
                ...
                <div class="row">
                    @php
                        $selectionnes = collect(old('techniciens', $reparation->techniciens->pluck('id')->all()))->map(fn ($v) => (int) $v);
                    @endphp
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="techniciens[]"
                                       ...
                                       @checked($selectionnes->contains($technicien->id))>
